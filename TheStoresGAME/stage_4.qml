        ...
        Rectangle
        {
            ...
            Rectangle
            {
                ...
                MouseArea
                {
                    ...
                    onClicked:
                    {
                        window_main.source_page_zoom = "/stage_4.qml"
                ...
                Rectangle
                {
                    ...
                    Text
                    {
                        ...
                        MouseArea
                        {
                            ...
                            onClicked:
                            {
                                if(i_i1.in_eq == true && i_i1.position == 1)
                                {
                                  c_s1 = "transparent"
                                ...
                                else   if(i_i1.in_eq == true && i_i1.position == 2)
                                {
                                  c_s2 = "transparent"
                                ...
                                else if(i_i1.in_eq == true && i_i1.position == 3)
                                {
                                  c_s3 = "transparent"
                                ...
                                else if(i_i1.in_eq == true && i_i1.position == 4)
                                {
                                  c_s4 = "transparent"
