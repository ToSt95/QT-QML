...
import "using_item.js" as MyScript_2
Rectangle
{
        ...
        Rectangle
        {
            ...
            Rectangle
            {
                ...
                MouseArea
                {
                    ...
                    onClicked:
                    {
                        window_main.source_page_zoom = "/nn.qml"
            ...
            Rectangle
            {
                ...
                Rectangle
                {
                    ...
                    Text
                    {
                        ...
                        MouseArea
                        {
                            ...
                            onClicked:
                            {
                                MyScript_2.use_item(i_i1,"stage_4.qml");
                ...
                Rectangle
                {
                    ...
                    Text
                    {
                        anchors.fill: parent
                        anchors.margins: 5
                        text: "Go Stage_3(need yellow item)";
                        ...
                        MouseArea
                        {
                            ...
                            onClicked:
                            {
                                MyScript_2.use_item(i_i2,"stage_3.qml");
